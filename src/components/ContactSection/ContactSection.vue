							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="form-holder">
											<input type="text" placeholder="Phone Number" class="form-control" id="lbl-03" :class="{ error: v$.phone.$error }" v-model="phone" @blur="v$.phone.$touch" @input="acceptNumber" />
											<span v-if="v$.phone.$error" class="error-form"><span class="error-icon" @click="errorFormsClick($event)"></span> <span class="error-title">Incorrect number</span></span>
										</div>
									</div>
									<div class="form-group">
								...
								<div class="col-12 d-flex justify-content-center justify-content-md-start">
									<a href="#" class="btn btn-dark" @click.prevent="sendForm()">Send Message</a>
								</div>
							</div>
						</form>
					</div>
